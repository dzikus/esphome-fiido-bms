...
static constexpr uint8_t HANDSHAKE_NOTIFY[] = {
    0x46, 0x64, 0xAA, 0x0D, 0x0D, 0x00, 0x00, 0x15, 0x16, 0x17, 0x18, 0x19, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x9C,
};
...
static constexpr uint8_t ENERGY_NOTIFY[] = {
    0x46, 0x64, 0xAA, 0x0C, 0xC8, 0x00, 0x00,  // off 0-1 crankTorque
...
static constexpr uint8_t STATS_NOTIFY[] = {
    ...
    0x00,
    0x00,
    0x00,  // off 20-22 (version, sellArea)
    0x00,
    0x00,
    0x01,
    0xAC,  // off 23-26 totalKm = 0x000001AC = 428 -> 42.8 km
    0x00,
    0x00,  // off 27-28 currentKm = 0
    0x00,
    0x00,  // off 29-30 bicycleSpeed = 0
